...
function pathIlbResources(
  ...
  resources.push(
    ...
    { provider: "compute", resourceType: "firewall_rule", name: `${prefix}-gateway-ingress`, risk: "high", summary: "Allow 136.124.16.0/20 to offload TCP 443 only", dependencies: [`compute:forwarding_rule:${prefix}-ilb-fr`] },
